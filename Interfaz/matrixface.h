#ifndef _matrixface_FACE_H
#define _matrixface_FACE_H
#include "celdaface.h"

class matrixface   /*Crea una matriz dinamica con vectores*/
{
private:
...
public:
        matrixface(coord my_incremento = 10);/*Constructor de matriz por defecto en 10x10*/
